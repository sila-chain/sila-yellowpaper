...
echo "Built pdf from \`$SHA\`. See https://github.com/sila-chain/yellowpaper/ for details." >> README.md
echo "The generated pdf is here: https://sila.github.io/yellowpaper/paper.pdf" >> README.md
