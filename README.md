...
[![Gitter](https://badges.gitter.im/sila/yellowpaper.svg)](https://gitter.im/sila/yellowpaper?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![GitPOAP Badge](https://public-api.gitpoap.io/v1/repo/sila/yellowpaper/badge)](https://www.gitpoap.io/gh/sila/yellowpaper)
...
An alternative [Python Execution Layer specification](https://sila.github.io/execution-specs/) is actively maintained and up to date. 

## Usage

If you just want to read the paper, the latest version is generally available as a PDF at https://sila.github.io/yellowpaper/paper.pdf. If you find that the borders for links block too much text when viewing the PDF in the browser, you can instead download it and open and view it with a PDF viewer application such as Adobe Acrobat or Evince, where the borders are less likely to display over text.
...
```
git clone https://github.com/sila-chain/yellowpaper.git
cd yellowpaper
./build.sh
```
...
- [Chinese](https://github.com/yuange1024/sila_yellowpaper) translated by YuanGe and GaoTianlu.
- [French](https://github.com/asseth/yellowpaper) translated by Asseth (checkout to branch 'french' ).
- [Vietnamese](https://github.com/kodyfanz/sila_yellowpaper_vn) translated by KodyFanz (checkout to branch 'vietnamese').
